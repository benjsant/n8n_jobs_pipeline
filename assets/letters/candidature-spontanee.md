<!--
Template QUASI-COMPLET : Candidature spontanée (pas d'offre publiée).
Quand le choisir : aucune offre précise, le candidat vise l'entreprise elle-même.
...
⚠️ Le corps de la lettre est FIGÉ (texte validé par le candidat). L'agent doit :
  1. Rédiger UNIQUEMENT l'[Accroche] (2-3 phrases : « pourquoi cette entreprise »).
     Sans offre, l'intérêt pour l'entreprise doit être LIMPIDE et sincère.
  2. Substituer les {{placeholders}} (entreprise, titre du candidat…).
...
Objet : Candidature spontanée ({{candidat.titre}})

Madame, Monsieur,

[Accroche : 2-3 phrases. Pourquoi {{entreprise.nom}} précisément (mission, produit,
valeurs, secteur, réputation technique). Sans fiche de poste, le choix de CETTE
...
Je vous remercie de l'attention portée à ma démarche et reste à votre disposition pour en échanger.
...
- Sans offre, rendre LIMPIDE le choix de cette entreprise avant tout.
- Exploiter un lien réel (stages CAF du Nord) si pertinent. Sincère, sans flatterie.
-->
